...
const BrandSection = () => {
  return (
 <section className="bg-white lg:h-[570px] md:h-[470px] text-black py-16 px-4 md:px-16 rounded-3xl font-kumbh max-w-8xl md:mx-6 mt-20">
  {/* Headings */}
  <div className="text-center mb-12 md:mb-16">
    <h2 className="text-4xl md:text-4xl lg:text-8xl font-semibold text-gray-300 whitespace-nowrap md:whitespace-normal">
      WE BUILD BRANDS
    </h2>
    <h3 className="text-4xl md:text-4xl lg:text-8xl font-bold -mt-1 md:mt-4 text-black">
      THAT SPEAK
    </h3>
  </div>
  ...
  <div className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-6">
    ...
    <div className="z-10 -mt-24 md:scale-125 md:-mt-32 order-2 md:order-none">
      <img
        src="/BTSMobile.png"
        alt="BTS Phone"
        className="h-[500px] sm:h-[650px] md:h-[550px] lg:h-[550px] md:w-[300px] w-auto"
      />
    </div>
