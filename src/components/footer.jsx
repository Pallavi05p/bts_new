    ...
    <footer className="max-w-[100vw] overflow-x-hidden">
      ...
      <div className="bg-white rounded-t-3xl px-6 md:px-20 py-10 flex flex-col md:flex-row justify-between gap-12">
        ...
        <div className="flex-1">
          <div>
            <img
              src="BTS Remove.png"
              alt="BTS Logo"
              className="h-24 w-auto object-contain mb-8 -mt-5"
            />
          </div>
        ...
        <div className="flex-1 md:grid md:grid-cols-3 flex-row gap-2 lg:-ml-48 text-sm text-gray-600">
          {/* Quick Links */}
          <div>
            <h4 className="font-semibold mb-2 text-left font-kumbh text-black">
              Quick Links
            </h4>
            <ul className="space-y-1 text-left font-dmsans text-[#1E1E1E82]">
              <Link to="/">
                <li className="hover:underline cursor-pointer mt-1 text-gray-400">
                  Home
                </li>
              </Link>
              <Link to="/about">
          ...
          <div className="flex flex-col items-center md:items-start gap-4 mr-10 ">
            <div>
              ...
              <ul className="space-y-1 text-left font-dmsans text-[#1E1E1E82]">
                <a href="tel:9284979500">
                  <li className="hover:underline cursor-pointer text-gray-400">
                    9284979500
                  </li>
                </a>
                <a href="tel:7741009500">
                  <li className="hover:underline cursor-pointer mt-1 text-gray-400">
                    7741009500
                  </li>
                </a>
                ...
                >
                  <li className="hover:underline cursor-pointer mt-1 text-left text-gray-400">
                    Khinavasara August Heighstreet, Office No. F-12,
                    <br />
                    Ulkanagari, Garkheda,
                    <br />
            ...
            <div className="flex justify-center md:justify-start gap-4 mt-4 mr-28 ">
              <a
